...
1. 加噪算法采用的是  analytic Gaussian mechanism，参考：[paper](https://proceedings.mlr.press/v80/balle18a/balle18a.pdf)。
2. 差分隐私采用的是 token-level 定义，参考：[paper](https://dl.acm.org/doi/10.1145/3576915.3616592)。
